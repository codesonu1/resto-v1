    ...
    <div className="section2-image">
      <Container>
        <div className="flex gap-3 justify-center pt-[8rem]">
          ...
          <p className="bg-[#F27E18] py-3 px-6 rounded-[5px] text-[1.5rem]  font-700 uppercase  text-black">
            deal
          </p>
        </div>
        <div className="grid grid-flow-row lg:grid-cols-3 md:grid-cols-3 py-[5rem]">
          <div>
            <span className="lg:flex justify-center">
              <BsSearch className="border bg-[white] text-[6rem] p-2 rounded-full text-[#F27E18] shadow-md" />
            </span>
          ...
          <div>
            <span className="lg:flex    justify-center">
              <BsSignDeadEnd className="border bg-[white] text-[6rem] p-2 rounded-full text-[#F27E18] shadow-md" />
            </span>
            <p className="lg:text-center text-white lg:px-8 py-3 text-[1.2rem]">
              Grab your Free Deal
            </p>
          ...
          <div>
            <span className="lg:flex justify-center">
              <FaMoneyBillWave className="border bg-[white] text-[6rem] p-2 rounded-full text-[#F27E18] shadow-md" />
            </span>
            <p className="lg:text-center text-white lg:px-8 py-3 text-[1.2rem]">
